...
The workbench itself comes from the `vue-design-lab` package; this project is your
studio — everything under `src/pages/` is your content.
...
the result matches the bundled starters.

## Export notes

- PNG defaults to 2x (~192 DPI); raise `scale` in the package's ExportBar to go higher
